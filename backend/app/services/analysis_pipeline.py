...
def update_job_status(
    ...
    from app.models.database import AnalysisJob, AnalysisStatus
...
def _save_diarization(session, job_id: str, data: dict):
    ...
    from app.models.database import Diarization, DiarizationSegment
...
def _save_scenes(session, job_id: str, data: dict):
    ...
    from app.models.database import Scene
...
def _save_hooks(session, job_id: str, hooks: list[dict]):
    ...
    from app.models.database import Hook
...
def _save_clips(session, job_id: str, clips: list[dict]):
    ...
    from app.models.database import ClipSuggestion
